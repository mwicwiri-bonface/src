...
class StockAdmin(admin.ModelAdmin):
    ...
    def make_active(self, request, queryset):
        ...
        self.message_user(request, ngettext(
            '%d Stock manager has successfully been marked as active.',
            '%d Stock managers have been successfully marked as active.',
            updated,
        ) % updated, messages.SUCCESS)

    make_active.short_description = "Approve Stock manager"

    def make_inactive(self, request, queryset):
        updated = queryset.update(is_archived=True)
        self.message_user(request, ngettext(
            '%d Stock manager has been archived successfully.',
            '%d Stock managers have been archived successfully.',
            updated,
        ) % updated, messages.INFO)

    make_inactive.short_description = "Archive Stock manager"
...
class StockFeedbackAdmin(admin.ModelAdmin):
...
admin.site.register(StockFeedback, StockFeedbackAdmin)
